...
echo -e " ${BIYellow}┌──────────────────────────────────────────────────┐${NC}" 
echo -e " ${BIYellow}│  \033[0m ${BOLD}${YELLOW}SSH     VMESS       VLESS      TROJAN $NC"    ${BIYellow}│${NC}"
echo -e " ${BIYellow}│  \033[0m ${Blue} $ssh1        $vmc           $vlx          $trx   $NC"     ${BIYellow}│${NC}"
echo -e " ${BIYellow}└──────────────────────────────────────────────────┘${NC}" 
...
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e " ${BICyan}|    [${BIWhite}11${BICyan}] BOT TELEGRAM${NC} "     ${BICyan}| ${NC}"
echo -e " ${BICyan}|    [${BIWhite}12${BICyan}] REGISTRASI IPVPS BARU${NC} "     ${BICyan}| ${NC}"
echo -e " ${BICyan}|    [${BIWhite}13${BICyan}] CLEAR SAMPAH${NC} "     ${BICyan}| ${NC}"
echo -e " ${BICyan}|    [${BIWhite}14${BICyan}] UPDATE SCRIPT${NC} "     ${BICyan}| ${NC}"
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
...
echo -e " ${BICyan}┌─────────────────────────────────────┐${NC}"
echo -e " ${BICyan}│  Version      ${NC} :${BIWhite} ${sem} ${IPurple}Last Update    ${BICyan}│${NC}"
echo -e " ${BICyan}│  User         ${NC} :${BIPurple} ${Name}    ${BICyan}│${NC}"
echo -e " ${BICyan}│  Expired      ${NC} :${RED} ${certificate} ${GREEN}(day)    ${BICyan}│${NC}"
echo -e " ${BICyan}└─────────────────────────────────────┘${NC}"
echo ""
