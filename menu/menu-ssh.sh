...
echo -e "$COLOR1 $NC  ${WH}SSH OVPN Account$NC" | tee -a /etc/log-create-user.log
echo -e "$COLOR1───────────────────────────${NC}" | tee -a /etc/log-create-user.log
...
echo -e "$COLOR1 $NC${WH}Port OpenSSH    ${COLOR1}: ${WH}$opensh" | tee -a /etc/log-create-user.log
echo -e "$COLOR1 $NC${WH}Port Dropbear   ${COLOR1}: ${WH}$db" | tee -a /etc/log-create-user.log
echo -e "$COLOR1 $NC${WH}Port SSH-UDP    ${COLOR1}: ${WH}1-65535" | tee -a /etc/log-create-user.log
echo -e "$COLOR1 $NC${WH}Port SSH-WS     ${COLOR1}: ${WH}80,8080" | tee -a /etc/log-create-user.log
echo -e "$COLOR1 $NC${WH}Port SSH-SSL-WS ${COLOR1}: ${WH}$wsssl" | tee -a /etc/log-create-user.log
echo -e "$COLOR1 $NC${WH}Port SSL/TLS    ${COLOR1}: ${WH}8443,8880" | tee -a /etc/log-create-user.log
echo -e "$COLOR1 $NC${WH}Port Ovpn Ws    ${COLOR1}: ${WH}2086" | tee -a /etc/log-create-user.log
...
echo -e "$COLOR1───────────────────────────${NC}" | tee -a /etc/log-create-user.log
echo -e "$COLOR1 $NC${WH}Port Slowdns ${COLOR1}: ${WH}80,443,53"
echo -e "$COLOR1 $NC${WH}Name Server ${COLOR1}: ${WH}$sldomain"
#echo -e "$COLOR1 $NC${WH}Name Server ${COLOR1}: ${WH}$nameserver"
echo -e "$COLOR1 $NC${WH}Public Key  ${COLOR1}: ${WH}$slkey"
#echo -e "$COLOR1 $NC${WH}Name Server ${COLOR1}: ${WH}$nameserver1"
#echo -e "$COLOR1 $NC${WH}Public Key  ${COLOR1}: ${WH}$slkey1"
echo -e "$COLOR1───────────────────────────${NC}" | tee -a /etc/log-create-user.log
echo -e "$COLOR1${NC}${WH}SSH UDP HC :                 ${NC}" | tee -a /etc/log-create-user.log
