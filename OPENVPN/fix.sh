...
curl "https://raw.githubusercontent.com/HssPunya93/jb/main/julak/insshws.sh" | bash



wget -O /usr/local/bin/edu-proxy https://raw.githubusercontent.com/HssPunya93/jb/main/julak/openssh.py && chmod +x /usr/local/bin/edu-proxy

wget -O /etc/systemd/system/edu-proxy.service https://raw.githubusercontent.com/HssPunya93/jb/main/julak/http.service && chmod +x /etc/systemd/system/edu-proxy.service
